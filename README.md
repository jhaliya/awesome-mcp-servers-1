...
- [Restk](https://restk.ai) - Native macOS API client with embedded MCP server (31+ tools). AI manages API workspaces — send requests, generate tests, import collections, detect errors — while schema extraction ensures credentials and PII are never exposed.
